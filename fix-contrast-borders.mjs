...
function fixFile(fn) {
  ...
  c = c.replace(/border-slate-100 shadow-sm dark:shadow-none hover:border-slate-200/g, 'border-gray-200 dark:border-[#2A2F3A] shadow-sm dark:shadow-none hover:border-gray-300 dark:hover:border-gray-600');
  ...
  c = c.replace(/border-slate-100 dark:border-\[#2A2F3A\]\/50 bg-gray-100 dark:bg-\[#1A1F26\]/g, 'border-gray-200 dark:border-[#2A2F3A] bg-gray-100 dark:bg-[#09090b]');
  // if some file has it slightly different:
  c = c.replace(/border-slate-100 dark:border-\[#2A2F3A\]\/50 bg-gray-100 dark:bg-\[#09090b\]/g, 'border-gray-200 dark:border-[#2A2F3A] bg-gray-100 dark:bg-[#09090b]');
  ...
  c = c.replace(/bg-gray-50 dark:bg-\[#1A1F26\] border border-gray-200 dark:border-\[#2A2F3A\]/g, 'bg-gray-50 dark:bg-[#09090b] border border-gray-200 dark:border-[#2A2F3A]');
  c = c.replace(/bg-white dark:bg-\[#1A1F26\] border border-gray-200 dark:border-\[#2A2F3A\] rounded-full/g, 'bg-white dark:bg-[#09090b] border border-gray-200 dark:border-[#2A2F3A] rounded-full');
