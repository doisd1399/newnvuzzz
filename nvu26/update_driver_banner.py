          ...
          <div className="flex flex-col w-full p-4 sm:p-5 md:p-6 relative z-10 gap-5 sm:gap-6">
            ...
            <div className="flex flex-row items-center justify-between">
              ...
              <div className="flex items-center gap-3 sm:gap-4 flex-1">
                <div className="relative w-[52px] h-[52px] sm:w-[64px] sm:h-[64px] rounded-full border border-teal-500/30 flex items-center justify-center shrink-0">
                  <ArrowUpRight size={28} className={bannerTextColor} strokeWidth={2.5} />
                </div>
                <div className="flex flex-col">
                  <span className={cn("text-[20px] sm:text-[26px] font-bold tracking-tight leading-none mb-1.5", bannerTextColor)}>
                    {status.label}
                  </span>
              ...
              <div className="flex flex-col items-end sm:items-start shrink-0">
                ...
                <div className="flex items-baseline gap-1">
                  <span className={cn("text-[32px] sm:text-[40px] font-bold leading-none", bannerTextColor)}>
                    {score}
                  </span>
            ...
            <div className="flex flex-row items-center justify-between sm:justify-start gap-4 sm:gap-10 mt-1">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-teal-500/30 flex items-center justify-center shrink-0">
                   <CalendarCheck size={18} className={bannerTextColor} strokeWidth={2} />
                </div>
                <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-teal-500/30 flex items-center justify-center shrink-0">
                   <TrendingUp size={18} className={bannerTextColor} strokeWidth={2.5} />
                </div>
                <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border border-teal-500/30 flex items-center justify-center shrink-0">
                   <DollarSign size={18} className={bannerTextColor} strokeWidth={2.5} />
                </div>
                <div className="flex flex-col">
            ...
            <div className="flex flex-row items-center gap-3 sm:gap-4 mt-2 bg-[#021317] rounded-xl sm:rounded-2xl p-2 sm:p-3 border border-white/5">
              <div className="flex-1 flex flex-col gap-1.5 sm:gap-2">
                <div className="flex justify-between items-center px-1">
                   <span className="text-[12px] sm:text-[14px] font-medium text-white/90">{Math.floor(currentLevelXp)} / 1.000 XP</span>
                   <span className={cn("text-[11px] sm:text-[13px] font-semibold", bannerTextColor)}>{Math.round(xpProgress)}%</span>
                </div>
              ...
              <div className="flex items-center gap-2 shrink-0 pr-1 sm:pr-2">
                 <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-teal-500/20 border border-teal-500/30 flex items-center justify-center">
                    <Star size={18} className={bannerTextColor} fill="currentColor" />
                 </div>
                 <span className="text-[12px] sm:text-[14px] font-bold text-white uppercase tracking-wider">
                   Nível <span className={cn("text-[14px] sm:text-[16px] ml-0.5", bannerTextColor)}>{currentLevel}</span>
                 </span>
              </div>
            </div>
          </div>
...
print("Updated DriverPerformanceCard successfully")
