...
/** Exact HF43 physical screenshots: sticky list message count must follow the visible Accept rows. */
public final class GtoHf44LiveListScreenshotsTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedImage page3 = ImageIO.read(new File("scripts/fixtures/hf44-list-page-3.png"));
        BufferedImage page2 = ImageIO.read(new File("scripts/fixtures/hf44-list-page-2.png"));
        req(page3 != null && page2 != null, "HF44 physical screenshots must load");
        GtoFastVisualDetector.Frame a = analyze(detector, page3, 1L);
        GtoFastVisualDetector.Frame b = analyze(detector, page2, 2L);
        System.out.println("counts=" + a.buttons.size() + "," + b.buttons.size());
        req(a.hasFreightList(), "page-3 screenshot must remain a real freight list");
        req(a.buttons.size() == 3, "page-3 screenshot must expose exactly 3 visible Accept rows");
        req(b.hasFreightList(), "page-2 screenshot must remain a real freight list");
        req(b.buttons.size() == 5, "page-2 screenshot must expose exactly 5 visible Accept rows");
        System.out.println("GtoHf44LiveListScreenshotsTest: PASS");
    }
