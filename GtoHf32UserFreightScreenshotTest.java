...
public final class GtoHf32UserFreightScreenshotTest {
    private static final File FIXTURE = new File("scripts/fixtures/hf32-user-real-freight-list-live.png");
    private static final File OVERLAY_FIXTURE = new File("scripts/fixtures/hf32-user-real-freight-list-overlay-open.png");
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedImage overlayOpen = ImageIO.read(OVERLAY_FIXTURE);
        require(overlayOpen != null, "real screenshot with NVU card open must load");
        GtoFastVisualDetector.Frame overlayFrame = analyze(detector, overlayOpen, 2L);
        require(overlayFrame.hasFreightList(),
            "NVU card open must not suppress freight-list recognition on the GTO panel");
        require(overlayFrame.buttons.size() == 5,
            "overlay-open screenshot must still expose exactly five freights");
        ...
        System.out.println("GtoHf32UserFreightScreenshotTest: PASS");
    }
