              ...
              <div className="space-y-2">
                {pendingApps.map((app) => {
                  ...
                  const displayPhoto =
                    ...
                    userMatch?.photoURL ||
                    userMatch?.avatar ||
                    `https://ui-avatars.com/api/?name=${encodeURIComponent(app.fullName)}&background=random`;
                  return (
                    <div
                      key={app.id}
                    ...
                    >
                      <div className="flex items-center gap-3 w-full sm:w-auto overflow-hidden">
                        <img
                          ...
                          className="w-9 h-9 rounded-full object-cover border border-gray-100 dark:border-[#2A2F3A] shrink-0"
                        />
                    ...
                    >
                      <div className="flex items-center gap-3 w-full sm:w-auto overflow-hidden">
                        <img
                          ...
                          alt={app.fullName}
                          referrerPolicy="no-referrer"
                          className="w-9 h-9 rounded-full object-cover border border-gray-100 dark:border-[#2A2F3A] shrink-0 opacity-80"
                        />
                        <div className="min-w-0 pr-2">
                          <p className="font-medium text-gray-900 dark:text-[#fafafa] text-[13px] truncate">
                            {app.fullName}
          ...
          <div className="bg-white dark:bg-[#1A1F26] rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col shadow-xl animate-in zoom-in-95 slide-in-from-bottom-2 duration-300">
            ...
            <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-[#2A2F3A]">
              <div className="flex items-center gap-3">
                <img
                  src={
                    selectedHistoryApp.photoURL ||
                    users.find((u) => u.email === selectedHistoryApp.email)
                      ?.photoURL ||
                    `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedHistoryApp.fullName)}&background=random`
                  }
